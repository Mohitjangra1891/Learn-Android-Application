...
public class bigpictureStyle_NOTIFICATION extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bigpicture_style_notification);
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("BigPicture Style Notification");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), CHANNEL_ID)
                        .setSmallIcon(R.drawable.notification)
                        .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.imgbtn))
                        .setContentTitle("Big Picture Style Notification")
                        .setStyle(new NotificationCompat.BigPictureStyle()
                                .bigPicture(BitmapFactory.decodeResource(getResources(), R.drawable.imgbtn)))
                        .setPriority(NotificationCompat.PRIORITY_DEFAULT);
