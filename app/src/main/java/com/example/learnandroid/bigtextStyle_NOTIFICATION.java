...
public class bigtextStyle_NOTIFICATION extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bigtext_style_notification);
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("BigText Style Notification");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), CHANNEL_ID)
                        .setSmallIcon(R.drawable.notification)
                        .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.bigtextnotification))
                        .setContentTitle("BigText Style Notification")
                        .setStyle(new NotificationCompat.BigTextStyle()
                                .bigText("Android is a mobile operating system based on modified version of Linux kernel and other open source software."))
                        .setPriority(NotificationCompat.PRIORITY_DEFAULT);
