...
public class autoComplete_Textview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String Javacode = "import android.support.v7.app.AppCompatActivity;\n" +
                ...
                "\t\t\t\t\t\t\t\tAutoCompleteTextViewDemo = (AutoCompleteTextView) findViewById(R.id.AutoCompleteTextViewDemo);\n" +
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("AutoComplete TextView");
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, androidx.appcompat.R.layout.support_simple_spinner_dropdown_item, text);
